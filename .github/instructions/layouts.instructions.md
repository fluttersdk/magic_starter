---
name: 'Layout Shell Conventions'
description: 'AppLayout/GuestLayout, navigation themes, responsive design, notification polling'
applyTo: 'lib/src/ui/layouts/**/*.dart'
---
