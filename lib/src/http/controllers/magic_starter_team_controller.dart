...
class MagicStarterTeamController extends MagicController
  ...
  Future<bool> doCreate({required String name}) async {
    ...
    try {
      ...
      Log.error('[MagicStarterTeamController.doCreate] $e\n$stackTrace');
      setError(trans('errors.unexpected'));
      return false;
    } finally {
      _isSubmitting = false;
  ...
  Future<bool> doUpdate({required String name}) async {
    ...
    try {
      ...
      Log.error('[MagicStarterTeamController.doUpdate] $e\n$stackTrace');
      setError(trans('errors.unexpected'));
      return false;
    } finally {
      _isSubmitting = false;
  ...
  Future<bool> doInvite({required String email, required String role}) async {
    ...
    try {
      ...
      Log.error('[MagicStarterTeamController.doInvite] $e\n$stackTrace');
      setError(trans('errors.unexpected'));
      return false;
    } finally {
      _isSubmitting = false;
  ...
  Future<bool> removeMember(dynamic memberId) async {
    ...
    try {
      ...
      Log.error('[MagicStarterTeamController.removeMember] $e\n$stackTrace');
      setError(trans('errors.unexpected'));
      return false;
    } finally {
      _isSubmitting = false;
  ...
  Future<bool> switchTeam(dynamic teamId) async {
    ...
    try {
      ...
      Log.error('[MagicStarterTeamController.switchTeam] $e\n$stackTrace');
      setError(trans('errors.unexpected'));
      return false;
    } finally {
      _isSubmitting = false;
